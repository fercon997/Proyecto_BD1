 ...
 * @author gabrielbaron
 */
public class MedicamentoView extends javax.swing.JDialog {
    MedicamentoController MedicamentoController = new MedicamentoController(this);
    /**
     * Creates new form Medicamento
     */
    public MedicamentoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        MedicamentoController.llenarTablaMedicamentos();
    ...
    private void initComponents() {
        ...
        jScrollPane5.setViewportView(Tabla_Medicamentos);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MedicamentoView dialog = new MedicamentoView(new javax.swing.JFrame(), true);
